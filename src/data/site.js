...
export const ROSTER = [
  ...
  { slug: "gaga",   name: "DJ Gaga",    img: "gaga",   mono: "GG", role: "Afrobeats · Amapiano · Street Pop", tags: ["Afrobeats", "Hip-Hop", "Amapiano", "Dancehall"], profile: true },
  { slug: "kiss",   name: "DJ Kiss",    img: "kiss",   mono: "KS", role: "Afrobeats · Amapiano · Afro House", tags: ["Afrobeats", "Amapiano", "Afro House", "R&B"],   profile: true },
  { slug: "xray",   name: "DJ Xray",    img: "xray",   mono: "XR", role: "Open Format · Luxury Events",       tags: ["Afrobeats", "Amapiano", "House", "Garage"],     profile: true },
  { slug: "karlos", name: "DJ Karlos",  img: "karlos", mono: "KL", role: "All Genres · Radio",                tags: ["Open Format", "All Genres", "Radio"],           profile: true },
];
...
export const PROFILES = {
  ...
  gaga: {
    name: "DJ Gaga", img: "gaga", gallery: ["gaga"],
    role: "DJ · Afrobeats, Amapiano & Street Pop", handle: "@djgaga01", ig: "https://instagram.com/djgaga01",
    based: "Lagos, Nigeria", tags: ["Afrobeats", "Hip-Hop", "Amapiano", "R&B", "Dancehall", "Street Pop"],
  ...
  kiss: {
    name: "Celebrity DJ Kiss", img: "kiss", gallery: ["kiss"],
    role: "DJ & Platform Founder · Afrobeats and House", handle: "@kiss.haus", ig: "https://instagram.com/kiss.haus",
    based: "Lagos, Nigeria", tags: ["Afrobeats", "Amapiano", "Afro House", "Tribal House", "R&B", "House"],
  ...
  xray: {
    name: "DJ Xray", img: "xray", gallery: ["xray"],
    role: "Premium Open Format DJ", handle: "@djxray", ig: "https://instagram.com/djxray",
    based: "London, UK", tags: ["Afrobeats", "Amapiano", "R&B", "Hip-Hop", "House", "Garage"],
  ...
  karlos: {
    name: "DJ Karlos", img: "karlos", gallery: ["karlos"],
    role: "DJ & Radio Resident · All Genres", handle: "@djkarlos_official", ig: "https://instagram.com/djkarlos_official",
    based: "Lagos, Nigeria", tags: ["Open Format", "All Genres", "Radio", "Club"],
...
export const MILESTONES = [
  ...
  { y: "2021", t: "BPM DJ Festival, Lagos", d: "A debut festival at Wave Beach. 10 DJs, 5,000+ in the crowd, noon till dawn." },
  { y: "2022", t: "The Beach House", d: "Partnered with Wave Beach to organize a rave with international DJs from around the world in one of the biggest beach parties." },
  { y: "2023", t: "Best DJ Crew, Rave Award", d: "The collective takes home Best DJ Crew." },
  { y: "2025", t: "Global Sound Central London Tour Run", d: "Fire DJ Flammzy's sound landed in Soho, from Greek Street to Mayfair." },
];
...
export const ALLIES = [
  {
    ...
    tier: "founding",
    blurb: "A professional rehearsal, recording and live session space. Our DJs get access to the studio on preferential terms through our partnership.",
  ...
  },
  {
    ...
    tier: "founding",
    blurb: "Cold-pressed organic juice brand and our beverage partner for D'Flamz events and activations.",
...
export const PROJECTS = [
  {
    ...
    summary: "Our flagship event brand, born in Mayfair and built around a single DJ taking a room through the world's music in one continuous set.",
  ...
  },
  {
    ...
    summary: "One of Lagos' largest beach music experiences, run in partnership with Wave Beach and Wakanow. Seventeen hours, more than ten DJs, thousands in attendance.",
  ...
  },
  {
    ...
    summary: "A talent development programme built with Kiss FM 98.9 Lagos to find, train and mentor DJs looking to turn the craft into a career.",
  ...
  },
  {
    ...
    summary: "A nationwide promotion and distribution campaign supporting Mavin Records' emerging artists, including Reekado Banks, Korede Bello and Di'Ja.",
  ...
  },
  {
    ...
    summary: "Promotional tours, media runs and club engagements connecting international artists and DJs with Nigerian audiences.",
...
export const EVENTS = [
  {
    ...
    blurb: "The flagship Global Sound night returns to Mayfair. One DJ, one continuous journey through the world's music.",
    ticketUrl: null,
    sponsored: false,
  },
];
