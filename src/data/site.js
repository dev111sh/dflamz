...
export const PROFILES = {
  flammzy: {
    ...
    role: "DJ · Afro, House, Rock Afrobeats, Hiphop Bashment, Old School, Global Sounds", handle: "@deejayflammzy", ig: "https://instagram.com/deejayflammzy",
    based: "Lagos · London", tags: ["Afrobeats", "House", "Rock", "Hip-Hop", "Global Sounds"],
    bio: "A London-based Nigerian music selector with over a decade on the decks and a genre range most DJs can never touch.",
    long: "Flammzy built his name blending Afrobeats, Afro House, Rock, Hip-Hop and Oldies into sets that move seamlessly from a Lagos rooftop to a Soho basement. He has worked with Don Jazzy, Reekado Banks, and several artistes. He has held a residency at Bheerhugz Cafe for over 12 years, trained DJs at Kiss Academy with Kiss FM, gave upcoming DJs opportunities to put their names on the map, headlined festival stages in front of thousands, and taken his sound across the UK on a Global Sound Tour running through Clapham, Mayfair and Shoreditch. Booking him gets you a seasoned professional who can open intimate and close euphoric, whatever the crowd.",
    highlights: [["Festival", "BPM DJ Festival, 5,000+"], ["Tour", "Global Sound Tour Central London · A Night with Mavins East African Tour"], ["Recognition", "Premier Records Excellence Award"]],
  },
  tonik: {
