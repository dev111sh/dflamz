...
export const PROFILES = {
  ...
  moniz: {
    ...
    based: "London, UK",
    tags: ["Afrobeats", "Amapiano", "Afro House", "Soulful House", "Tribal", "R&B", "Hip-Hop", "Vinyl"],
    bio: "An international DJ and producer of eighteen years, resident at After IX in Mayfair, with a club history running through Ibiza and Ministry of Sound.",
    long: "DJ Moniz has been behind the decks for over eighteen years and plays across Afrobeats, Amapiano, Afro house, soulful house, tribal, R&B and Hip-Hop. The club history is the part that travels: Ibiza rooms including Amnesia, Es Paradis, Eden and Privilege, along with Ministry of Sound in London and bookings in Lagos, Houston, Slovakia and Marrakech. He is a traditional mixer as much as a digital one, equally comfortable on vinyl or a modern setup, which is rarer than it sounds among DJs who came up after the changeover. He produces his own original music alongside the DJing, and currently holds a residency at After IX, Chargal Mayfair in London. Available for clubs, festivals, concerts, artist support and international bookings.",
    highlights: [
      ["Experience", "18+ years"],
      ["Residency", "After IX, Chargal Mayfair, London"],
      ["Clubs", "Amnesia, Es Paradis, Eden, Privilege, Ministry of Sound"],
      ["Also", "Producer; plays vinyl and digital"],
      ["Based", "London, UK"],
    ],
  },
