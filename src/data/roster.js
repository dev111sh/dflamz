...
export const ROSTER = [
  ...
  { slug: "moniz", name: "DJ Moniz", img: "moniz", mono: "MZ", role: "Afro House · Soulful House · London", tags: ["R&B", "Hip-Hop", "Dancehall", "Afrobeats", "Amapiano", "Afro House", "Soulful House", "Tribal House"], profile: true },
...
export const PROFILES = {
  ...
  moniz: {
    name: "DJ Moniz", img: "moniz", gallery: ["moniz"],
    role: "DJ & Producer · Resident at After IX, Mayfair",
    handle: "@dj_moniz", ig: "https://instagram.com/dj_moniz",
    based: "London, UK",
    tags: ["R&B", "Hip-Hop", "Dancehall", "Afrobeats", "Amapiano", "Afro House", "Soulful House", "Tribal House", "Vinyl"],
    bio: "A London DJ and producer with over eighteen years behind the decks, resident at After IX in Mayfair and booked internationally.",
    long: "DJ Moniz has been playing for over eighteen years across the UK and internationally, and the range is the point: R&B, Hip-Hop, dancehall, Afrobeats, Amapiano, Afro house, soulful house and tribal house all sit in the same set, held together by reading the room rather than by a fixed lane. The sets lean on musical depth and technical precision, and on knowing where a night's energy is going before the floor does. His career includes performances at some of the most recognised club destinations in the world, including Amnesia, Es Paradis and Privilege in Ibiza, the last formerly recognised by Guinness World Records as one of the world's largest nightclub venues and now home to UNVRS. International bookings have taken him to Lagos, Houston, Slovakia and Marrakech. A traditional DJ at heart, he is equally comfortable on vinyl or a modern digital setup, and he produces his own music alongside the DJing. He currently holds a residency at After IX, Chargal Mayfair, and is available for clubs, festivals, concerts, artist support and international bookings.",
    highlights: [
      ["Experience", "18+ years"],
      ["Residency", "After IX, Chargal Mayfair, London"],
      ["Clubs", "Amnesia, Es Paradis, Privilege (now UNVRS), Ibiza"],
      ["Also", "Producer; vinyl and digital"],
      ["Based", "London, UK"],
    ],
  },

  xiano: {
    name: "DJ Xiano", img: "xiano", gallery: ["xiano"],
    role: "DJ · Afrobeats, House and Dancehall",
    handle: "@djxiano", ig: "https://instagram.com/djxiano",
    based: null,
    tags: ["Afrobeats", "House", "Reggae", "Dancehall", "Hip-Hop", "R&B"],
    bio: "A DJ moving between Afrobeats, house, reggae and dancehall, with Hip-Hop and R&B rounding out the selection.",
  ...
  dino: {
    name: "Sexydjdino", img: "dino", gallery: ["dino"],
