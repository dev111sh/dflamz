...
export const EVENTS = [
  ...
  },
  {
    ...
    endDate: '2026-10-31',
    time: null,
    venue: 'London, Glasgow, Bradford, Manchester and Liverpool',
    city: 'United Kingdom',
    dj: 'shawn',
    img: 'evShawnUkTour',
    gallery: [],
    lineup: [],
    tags: ['UK Tour', 'Nightlife', 'Afrobeats'],
    blurb:
      "DJ Shawn's UK tour runs through October across five cities, with more dates to be announced.",
    description:
      "DJ Shawn takes the UK across October 2026: London on the 2nd, Glasgow on the 3rd, Bradford on the 10th, Manchester on the 17th and Liverpool on the 31st. More dates to follow. Part of The Awesome Tour 2026, with Japa Wave, Piano Wave, DAB, Braunie and D'Flamz.",
    price: null,
    ticketUrl: null,
    sponsored: false,
  },
